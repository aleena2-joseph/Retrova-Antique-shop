...
if (!$prod) { http_response_code(404); echo 'Not found'; exit; }
$cats = Category::all();
$err='';
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($title && $price >= 0) {
        Product::update($id, $title, $desc, $price, $stock, $imgName, $cat);
...
<style>
  /* Vintage Product Edit Form Styling */
  :root {
    --vintage-gold: #d4af37;
    --vintage-dark: #2c1810;
...
<div class="vintage-form-wrapper">
  <div class="vintage-form-container">
    <div class="vintage-form-header">
      <h4 class="vintage-form-title">Edit Product</h4>
    </div>
      ...
      <form method="post" enctype="multipart/form-data">
        <div class="form-row">
          <div class="form-col-8">
            ...
            <input class="vintage-form-input" name="title" value="<?php echo htmlspecialchars($prod['title']); ?>" required>
          </div>
          <div class="form-col-4">
            ...
            <select class="vintage-form-select" name="category_id">
              ...
              <?php foreach ($cats as $c): ?>
                <option value="<?php echo $c['id']; ?>" <?php echo $prod['category_id']==$c['id']?'selected':''; ?>>
        ...
        <div class="form-row">
          <div class="form-col-12">
            ...
            <textarea class="vintage-form-textarea" name="description" rows="5"><?php echo htmlspecialchars($prod['description']); ?></textarea>
          </div>
        </div>
        ...
        <div class="form-row">
          <div class="form-col-4">
            ...
            <input class="vintage-form-input" type="number" step="0.01" name="price" value="<?php echo htmlspecialchars($prod['price']); ?>" required>
          </div>
          <div class="form-col-4">
            <label class="vintage-form-label">Stock</label>
            <input class="vintage-form-input" type="number" name="stock" value="<?php echo (int)$prod['stock']; ?>" required>
          </div>
          <div class="form-col-4">
        ...
        <div class="vintage-form-actions">
          <button class="vintage-btn-submit" type="submit">Save Changes</button>
